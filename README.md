...
## Запуск
### Вариант 1 [Dockerfile](https://github.com/Leo-Amv/Bank-service/blob/main/Dockerfile)
...
### Вариант 2 с помощью файла [docker-compose.yml](https://github.com/Leo-Amv/Bank-service/blob/main/docker-compose.yml)
- Через терминал собираем jar архив с spring boot приложением: `./mvn clean package`
